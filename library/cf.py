...
db_ip='localhost'
# db 패스워드
db_passwd='qlalfqjsgh1!' # [mysql password 를 넣어주세요]
...
imi1_accout="8060105511" # [모의투자 계좌번호를 넣어주세요. 주의! 10자리 계좌번호입니다. 모의투자는 8자리 계좌번호 뒤에 11, 실전은 10이 붙어 있음]
